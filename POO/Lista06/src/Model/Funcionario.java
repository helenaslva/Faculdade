...
public class Funcionario {
    ...
    public void setSalario(double salario) {
        if(salario <= 0){
            throw new IllegalArgumentException("O salário não pode ser menor que 0");
        }
    ...
    /**
     * Método que calcular o imposto de renda do funcionário com base no salário
     * e na lista de classificação de imposto de renda abaixo:
     * <ul>
