...
public class AppUi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btOnClickAvaliar.setText("Avaliar");
        btOnClickAvaliar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btOnClickAvaliarActionPerformed(evt);
            }
        });
    ...
    private void btOnClickAvaliarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOnClickAvaliarActionPerformed
        double salario = Double.parseDouble(tfSalario.getText());

        Funcionario func = new Funcionario("Func", salario);

        DecimalFormat df = new DecimalFormat("0.00");
        lbMensagemFaixa.setText("O IRPF do funcionário é R$:  "
                + df.format(func.calcularIrpf()));
        lbMensagemImposto.setText("O salário está na " + func.identificarFaixaIrpf() + "ª faixa");
        
        
    }//GEN-LAST:event_btOnClickAvaliarActionPerformed
    ...
    private javax.swing.JButton btOnClickAvaliar;
