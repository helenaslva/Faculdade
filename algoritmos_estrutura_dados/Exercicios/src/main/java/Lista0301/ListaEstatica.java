...
public class ListaEstatica<T> {
    ...
    /**
     * Construtor padrão: Cria o vetor para armazenar os dados e estabelece que
     * a lista está vazia
     */
    ...
    /**
     * Busca por um valor na lista, se encontrar retorna o indice do mesmo no
     * vetor. Caso não encontre, retornará -1.
     *
     ...
     * @return o elemento da posição informada se existir a posição na lista,
     * caso contrário irá lançar uma exceção.
     */
     ...
     *
     * @return um valor verdadeiro se a lista estiver vazia, e um valor falso
     * caso a lista possua algum elemento.
     */
